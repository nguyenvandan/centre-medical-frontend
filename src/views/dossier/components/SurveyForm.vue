<template>
  <div v-if="jsform && jsform.length" :class="formContainerClass">
    ...
    <div class="flex w-full mt-1 mb-3 sm:px-3 items-center">
      ...
      <div class="w-10/12 lg:w-8/12 flex justify-center">
        <h2 class="text-left sm:text-center text-white bg-twarning py-2 px-5"><b>Je remplis le questionnaire médical</b></h2>
      </div>
    </div>
    ...
    <div v-for="(question, idx) in jsform" :key="idx" class="w-full">
      ...
      <div :class="qContainerClass">
        <!-- question -->
        <div :class="qClass"><span v-if="question.ansrequired" class="text-red-500 mr-1">*</span><span v-html="question.q"></span></div>
        <!-- question radio box -->
